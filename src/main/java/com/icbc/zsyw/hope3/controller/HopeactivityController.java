...
public class HopeactivityController {
    ...
    */
    ...
    public BaseResponse<List<HopeactivityServiceImpl.ActivityClass>> queryHopeActivity(HttpServletRequest request, @RequestBody HopePrivGroup hopePrivGroup){
        log.info("queryHopeActivityStart hopePrivGroup {}", JSON.toJSONString(hopePrivGroup));
        BaseResponse<List<HopeactivityServiceImpl.ActivityClass>> response = hopeactivityService.queryHopeActivity(hopePrivGroup);
