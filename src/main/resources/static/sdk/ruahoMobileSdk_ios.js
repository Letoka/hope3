...
;cordova.define("com.ruaho.plugin", function(require, exports, module) {
   ...
   cordova.exec(success,fail,"RuahoPlugin","get",[key]);
   };
   
   RuahoPlugin.set = function(key,value,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","set",[key, value]);
   };
   
   RuahoPlugin.invokeNative = function(key,value,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","invokeNative",[key, value]);
   };
               
   RuahoPlugin.saveData = function(table, paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","saveData",[table, paramObj]);
   };
               
   RuahoPlugin.batchSave = function(table, paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","saveDataArray",[table, paramObj]);
   };
               
   RuahoPlugin.getData = function(table, paramObj ,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","getData",[table, paramObj]);
   };
               
   RuahoPlugin.getDataCount = function(table, paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","getDataCount",[table, paramObj]);
   };
               
   RuahoPlugin.removeData = function(table, paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","removeData",[table, paramObj]);
   };
 //语音播放
   RuahoPlugin.playVoice = function(paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","playVoice",[paramObj]);
   };
   RuahoPlugin.pauseVoice = function(paramObj,success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","pauseVoice",[paramObj]);
   };
   RuahoPlugin.stopVoice = function(paramObj, success,fail) {
   cordova.exec(success,fail,"RuahoPlugin","stopVoice",[paramObj]);
   };
   
   RuahoPlugin.clearRedFlag = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "clearRedFlag", [paramObj]);
   }
   
   RuahoPlugin.addRedFlag = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "addRedFlag", [paramObj]);
   }
   
   RuahoPlugin.startUserChat = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "startUserChat", [paramObj]);
   }
   
   RuahoPlugin.startGroupChat = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "startGroupChat", [paramObj]);
   }
   
   RuahoPlugin.datepicker = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "datepicker", [paramObj]);
   }
   
   RuahoPlugin.closeWindow = function() {
   cordova.exec(jQuery.noop, jQuery.noop, "RuahoPlugin", "closeWindow", [{}]);
   }
   
   RuahoPlugin.previewImage = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "previewImage", [paramObj]);
   }
   
   RuahoPlugin.chooseImage = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "chooseImage", [paramObj]);
   }
   
   RuahoPlugin.uploadImage = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "uploadImage", [paramObj]);
   }
   
   RuahoPlugin.openLocation = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "openLocation", [paramObj]);
   }
   
   RuahoPlugin.getLocation = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getLocation", [paramObj]);
   }
   
   RuahoPlugin.scanQRCode = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "scanQRCode", [paramObj]);
   }
   
   RuahoPlugin.saveServDef = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "saveServDef", [paramObj]);
   }
   
   RuahoPlugin.getServDefValue = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getServDefValue", [paramObj]);
   }
   
   RuahoPlugin.getServDefDigest = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getServDefDigest", [paramObj]);
   }
   
   RuahoPlugin.getDictTree = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getDictTree", [paramObj]);
   }
   
   RuahoPlugin.getServer = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getServer", [paramObj]);
   }
               
   RuahoPlugin.getToken = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getToken", [paramObj]);
   }
   
   RuahoPlugin.getUuid = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "getUuid", [paramObj]);
   }
   ...
   RuahoPlugin.setRightTopMenu = function(menuObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "setRightTopMenu", [menuObj]);
   }
               
   RuahoPlugin.showBackBtn = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "showBackBtn", [paramObj]);
   }
               
   RuahoPlugin.modifyWebViewTitle = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "modifyWebViewTitle", [paramObj]);
   }
               
   RuahoPlugin.showWaterView = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "showWaterView", [paramObj]);
   }
               
   RuahoPlugin.showTokenInvalidRemind = function(paramObj, success, error) {
   cordova.exec(success, error, "RuahoPlugin", "showTokenInvalidRemind", [paramObj]);
   }

   RuahoPlugin.saveImageToPhotoLibrary = function(paramObj, success, error) {
    cordova.exec(success, error, "RuahoPlugin", "saveImageToPhotoLibrary", [paramObj]);
    }

    RuahoPlugin.getPostion = function(paramObj, success, error) {
    cordova.exec(success, error, "RuahoPlugin", "getPostion", [paramObj]);
    }
